    ...
    <template v-else>
      ...
      <el-card shadow="never">
        ...
        <el-table :data="filteredRules" size="small"
          ...
          <el-table-column type="index" :label="t('school.rules.colIndex')" width="60" align="center" />
          <el-table-column :label="t('school.rules.colLevel')" width="90" align="center">
          ...
          <el-table-column :label="t('school.rules.colChannels')" width="200">
            <template #default="{ row }">
          ...
          <el-table-column :label="t('school.rules.colTriggerCond')" min-width="200">
            <template #default="{ row }">
              ...
              <div class="condition-tags">
                ...
                <span v-if="ruleTriggerTags(row).length === 0" class="text-secondary">{{ t('school.rules.noCondition') }}</span>
              </div>
            </template>
          </el-table-column>
          <el-table-column :label="t('school.rules.colAction')" width="150" align="center">
            <template #default="{ row }">
              ...
              <el-button size="small" link type="primary" @click="openTriggerDetail(row)">{{ t('school.rules.triggerDetail') }}</el-button>
            </template>
          </el-table-column>
        </el-table>
      </el-card>
