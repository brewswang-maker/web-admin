...
const enUS: MessageSchema = {
  ...
  menu: {
    ...
    algoConfigDesc: 'View inference algorithms, scheduling status and ROI resources bound to each channel — read-only page; all configuration and drawing is done in Event Rules',
...
,
  ...
  perimeter: {
    ...
    rules: {
      title: 'Event Rules',
      subtitle: 'Perimeter linkage rule instances — VP-* template landing map / channel binding / trigger stats; idempotently instantiated via "Check && Deploy" on Scene Packs',
  ...
  school: {
    rules: {
      ...
      subtitle: 'School linkage rule instances — SC-* template landing map / channel binding / trigger stats; idempotently instantiated via "Check && Deploy" on Scene Packs',
      loadFailed: 'Failed to load rules',
      statRules: 'Rule Instances',
      statEnabled: 'Enabled',
      statTriggers: 'Total Triggers',
  ...
  gas: {
    rules: {
      ...
      subtitle: 'Gas station linkage rule instances — GS-* template landing map / channel binding / trigger stats; idempotently instantiated via "Check && Deploy" on Scene Packs',
      loadFailed: 'Failed to load rules',
      statRules: 'Rule Instances',
      statEnabled: 'Enabled',
      statTriggers: 'Total Triggers',
