...
test.describe('3D厂区态势地图 — 页面加载', () => {
  ...
  test('地图面板标题显示正确', async ({ page }) => {
    ...
    await expect(mapPanel).toContainText('3D 厂区态势地图')
  })
})
